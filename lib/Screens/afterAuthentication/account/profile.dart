...
class Profile extends StatefulWidget {
  ...
  //List<Usercol> asd = []; // Just so Initial Value is not null and avoid red screen
...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<Usercol?>(
      stream: DatabaseService(uid: userr?.uid).userData,
      builder: (context, snapshot) {
        final Authservice _auth =Authservice();
        if (snapshot.hasData) {
          Usercol? userDataw = snapshot.data;
          return Scaffold(
              appBar: AppBar(
                ...
                actions: <Widget>[
                  ...
                  IconButton(
                    icon: Icon(Icons.person, color: Colors.black,), hoverColor: Colors.white, onPressed: () {setState(() {
                    setState(() {
                      initState();
                    });
                  });},),
                      ...
                      decoration: BoxDecoration(border: Border.all(width: 2,color: Colors.black12)),
                        child:
                         Row(
                              ...
                              children: <Widget>[
                                FlatButton.icon(onPressed: (){Navigator.pushNamed(context, '/addproduct');}, icon: Icon(Icons.create_sharp), label: Text('Add Product',style: TextStyle(fontWeight: FontWeight.bold),)),
                                FlatButton.icon(onPressed: (){Navigator.pushNamed(context, '/vieworders');}, icon: Icon(Icons.edit_attributes_outlined), label: Text('View Orders',style: TextStyle(fontWeight: FontWeight.bold),)),
                        ],
                      ),
                    )
            ],
...
// return StreamProvider<List<Usercol>?>.value(
...
//               icon: Icon(Icons.search, color: Colors.black,), hoverColor: Colors.white, onPressed: () {},),
//             IconButton(
//               icon: Icon(Icons.person, color: Colors.black,), hoverColor: Colors.white, onPressed: () {},),
//             SizedBox(width: 70)
//           ],),
//         body: Center(
//           child: Column(
...
//                   ''),),
//               SizedBox(height: 10,),
//               Text('Kumail Raza',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
//               Container(
...
//                     constraints: BoxConstraints(maxWidth: double.infinity,maxHeight: 40,minHeight: 39),
//                     child: Padding(
//                       padding: EdgeInsets.fromLTRB(80, 10, 80, 10),
//                       child: Row(
//                       mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                       children: <Widget>[
//                         FlatButton.icon(onPressed: (){}, icon: Icon(Icons.create_sharp), label: Text('Create Post',style: TextStyle(fontWeight: FontWeight.bold),)),
//                         FlatButton.icon(onPressed: (){}, icon: Icon(Icons.edit_attributes_outlined), label: Text('Edit Profile',style: TextStyle(fontWeight: FontWeight.bold),)),
//                       ],
//                     ),
//                   ),),
//               ListTile(
